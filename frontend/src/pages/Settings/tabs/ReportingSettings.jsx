        ...
        <div className="space-y-8">
            ...
            <div className="bg-base-50 p-6 rounded-2xl border border-base-200">
                <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    ...
                    {t('settings.reporting.header_title')}
                </h3>

                <div className="form-group mb-6">
                    <label className="form-label">{t('settings.reporting.report_header')}</label>
                    <textarea
                ...
                <div className="form-group">
                    <label className="form-label">{t('settings.reporting.report_footer')}</label>
                    <textarea
                        className="form-input min-h-[80px]"
            ...
            <div className="bg-base-50 p-6 rounded-2xl border border-base-200">
                <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    ...
                    {t('settings.reporting.print_options')}
                </h3>
                <div className="flex items-center gap-3">
                    ...
                    <label className="cursor-pointer font-medium" htmlFor="report_show_logo">
                        {t('settings.reporting.show_logo')}
                    </label>
                </div>
            </div>
        </div>
