        ...
        <div className="workspace fade-in">
            <div className="workspace-header">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
                    <div>
                        <h1 className="workspace-title">📋 إشعارات دائنة (مبيعات)</h1>
                        <p className="workspace-subtitle">Credit Notes - تخفيض رصيد العميل (مرتجعات / تصحيح أسعار)</p>
                    </div>
            ...
            {showDetail && detailItem && (
                <div className="modal-overlay" onClick={() => setShowDetail(false)}>
                    <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: 800, maxHeight: '90vh', overflow: 'auto' }}>
                        <div className="modal-header">
                            <h2>إشعار دائن: {detailItem.invoice_number}</h2>
                        ...
                        <div style={{ padding: 20 }}>
                            ...
                            {detailItem.related_invoice_number && (
                                <p style={{ marginBottom: 12 }}>🔗 مرتبط بالفاتورة: <strong>{detailItem.related_invoice_number}</strong></p>
                            )}
                            {detailItem.notes && <p style={{ marginBottom: 16, color: '#666' }}>📝 {detailItem.notes}</p>}
                            <table className="data-table">
                                <thead>
                                    <tr><th>الوصف</th><th>الكمية</th><th>السعر</th><th>الضريبة %</th><th>الخصم</th><th>الإجمالي</th></tr>
                                </thead>
                                <tbody>
