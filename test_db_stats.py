...
# Replace with an actual DB path, e.g. company_1
DB_URL = "sqlite:////home/omar/Desktop/aman/backend/db/company_1.db"
import os
print(os.path.exists("/home/omar/Desktop/aman/backend/db/company_1.db"))
...
try:
    with engine.connect() as db:
        ...
        try:
            ...
            print("calculate_period_stats total_income SUCCESS", total_income)
        except Exception as e:
            print("calculate_period_stats total_income FAIL", e)
