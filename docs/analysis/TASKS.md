...
- [ ] **[HR-005]** مسيرات الرواتب المطبوعة (Payslip)
  - [ ] قالب مسير راتب
  - [ ] طباعة PDF
  - [ ] إرسال بالبريد الإلكتروني
  - [ ] بوابة موظف لتحميل المسير

### 4.2 الحضور والإجازات

- [ ] **[HR-006]** رصيد الإجازات المرحّل
  - [ ] ترحيل رصيد نهاية السنة
  - [ ] حد أقصى للترحيل
  - [ ] انتهاء صلاحية الرصيد المرحّل
